...
### 3.1. [560. 和为 K 的子数组](https://leetcode.cn/problems/subarray-sum-equals-k/)
...
### 3.2. [238. 除自身以外数组的乘积](https://leetcode.cn/problems/product-of-array-except-self/)
...
### 3.3. [53. 最大子数组和](https://leetcode.cn/problems/maximum-subarray/)
...
### 3.4. [525. 连续数组](https://leetcode.cn/problems/contiguous-array/)
...
| 题号 | 题目                                                                                                   | 标签                      |
| ---- | ---------------------------------------------------------------------------------------------------- | ------------------------- |
| 3891 | [最大化特殊下标数目的最少增加次数](https://leetcode.cn/problems/minimum-increments-to-maximize-the-number-of-special-indices/) | 前缀处理 / 奇偶前缀和 / 提升题 |
| 3862 | [找出最小平衡下标](https://leetcode.cn/problems/find-the-smallest-balanced-index/) | 前后缀分解 / 上溢 / 后序遍历 / 模板题 |
| 3739 | [统计主要元素子数组数目 II](https://leetcode.cn/problems/count-subarrays-with-majority-element-ii/) | 枚举右维护左 / 有序集合 / 提升题     |
| 3381 | [长度可被 K 整除的子数组的最大元素和](https://leetcode.cn/problems/maximum-subarray-sum-with-length-divisible-by-k/) | 前缀处理 / 枚举右维护左 / 提升题     |
| 1653 | [使字符串平衡的最少删除次数](https://leetcode.cn/problems/minimum-deletions-to-make-string-balanced/) | 前后缀分解 / 动态规划 / 提升题      |
